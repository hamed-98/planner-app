...
export const DEFAULT_NEURO_HABITS: NeuroHabit[] = [
  ...
  {
    id: "4",
    title: "فاصله گرفتن از نور آبی پیش از خواب",
    completed: false,
    xp: 15,
  },
...
export const DEFAULT_NEURO_ARTICLES = [
  {
    ...
    icon: "🧠",
    summary:
      "چگونه مغز با یادگیری و تجارب جدید مسیرهای عصبی خود را از نو می‌سازد.",
    content:
      "تحقیقات نشان می‌دهند که مغز تا پایان عمر توانایی ساخت اتصالات جدید را حفظ می‌کند...",
  },
  {
    id: "dopamine-fasting",
    ...
    icon: "⚡",
    summary:
      "راهکارهای کاهش بمباران اطلاعاتی و بهبود حساسیت گیرنده‌های دوپامین.",
    content:
      "دوپامین هورمون انگیزه است، نه صرفاً لذت. با فواصل آگاهانه بازدهی ذهنی خود را دوچندان کنید...",
  },
];
